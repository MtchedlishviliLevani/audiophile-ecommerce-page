...
export const cartPageContent: cartPageContentType = {
  XX99MARKII: {
    ...
    productMainImg: {
      mobile:
        // fix
        require("../../src/assets/images/product-xx99-mark-two-headphones/mobile/image-product.jpg"),
      tablet: require("../../src/assets/images/product-xx99-mark-two-headphones/tablet/image-product.jpg"),
      desktop: require("../../src/assets/images/product-xx99-mark-two-headphones/desktop/image-product.jpg"),
    },
    price: 2999,
    paragraph:
      "The new XX99 Mark II headphones is the pinnacle of pristine audio. It redefines your premium headphone experience by reproducing the balanced depth and precision of studio-quality sound.",

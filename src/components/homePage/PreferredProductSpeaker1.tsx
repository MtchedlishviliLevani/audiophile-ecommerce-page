...
function PreferredProductSpeaker1() {
    return (
        <div className="bg-buttonBackground  w-[100%]  relative pt-[270px] sm:pt-[320px] lg:pt-[130px] pb-[55px] lg:pb-[124px] rounded-[8px] lg:pr-[95px]">
            ...
            <img className="absolute z-10 top-0 left-0 sm:translate-x-[-50%] sm:left-[50%] lg:left-[220px]  sm:w-[400px] lg:w-[650px] object-cover" src={circle} alt="" />
            <div className="text-center w-[90%] sm:w-[60%] lg:w-[33%] m-auto lg:m-[initial] lg:ml-auto">
                ...
                <Button color="primaryBackground" hoverBg="hoverBlackColorBg" position="initial" />
            </div>
        </div>
    )
}

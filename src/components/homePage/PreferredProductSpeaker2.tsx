...
function PreferredProductSpeaker2() {
    return (
        <div className="bg-[url('/images/home/mobile/image-speaker-zx7.jpg')] md:bg-[url('/images/home/tablet/image-speaker-zx7.jpg')] lg:bg-[url('/images/home/desktop/image-speaker-zx7.jpg')] bg-[length:100%_100%] w-[100%] h-[320px] py-[101px] pl-[48px] lg:pl-[82px] my-[32px] rounded-[8px] ">
            <div>

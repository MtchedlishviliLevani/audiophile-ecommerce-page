...
function Footer() {
    return (
        <footer className="bg-primaryBackground  text-center md:text-left  " >
            <div className="container   mx-auto pt-12 pb-9  xl:bg-black-500 relative  ">
                <div className="w-[100px] h-1 bg-buttonBackground absolute left-[50%] md:left-[5%] md:translate-x-[initial] top-[0px] translate-x-[-50%] "></div>
